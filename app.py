...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = ( os.environ.get('DATABASE_URL', 'postgresql:///justeats'))
...
with app.app_context():
    ...
    def handle_registration():
        ...
        if form.validate_on_submit():
            firsName = form.first_name.data
            lastName = form.last_name.data
            username = form.username.data
            email = form.email.data
            password = form.password.data
            user = User.register(firsName, lastName, email, username, password)
